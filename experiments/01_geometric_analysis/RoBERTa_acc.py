...
training_args = TrainingArguments(
    output_dir="./tinybert-agnews-diff-embed-v2", # تغییر نام پوشه خروجی برای مقایسه
    eval_strategy="epoch",
    save_strategy="epoch",
    learning_rate=5e-5,
    ...
    num_train_epochs=3,
    weight_decay=0.01,
    logging_dir="./logs-diff-embed-v2", # تغییر نام پوشه لاگ
    logging_steps=100,
    ...
    dataloader_num_workers=0,  # حذف multi-processing برای deterministic بودن
    remove_unused_columns=False,  # جلوگیری از تغییرات غیرقابل پیش‌بینی
)
